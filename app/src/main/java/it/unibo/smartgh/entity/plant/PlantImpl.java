...
public class PlantImpl implements Plant {
    ...
    private final Map<ParameterType, PlantParameter> parameters;
    ...
    public PlantImpl(String name,
                     String description,
                     String img,
                     Map<ParameterType, PlantParameter> parameters) {
        this.name = name;
    ...
    @Override
    public Map<ParameterType, PlantParameter> getParameters() {
